package com.khopa.oneStory.services.configuration.impl;
 ...
 *
 */
public class OneStoryConfigurationService extends ConfigurationService {

	/**
	 * Path to the conf file
	 */
	private final static String filePath = "OneStory/Config/config.xml";
